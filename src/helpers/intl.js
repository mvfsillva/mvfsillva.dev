const intl = {
  ...
  about: {
    'pt-br': {
      ...
      description: [
        'Natural de Salvador/BA, cresci no bairro da Mata Escura, atualmente mostro todo dendê da Bahia em São Paulo/SP, e trabalho como desenvolvedor sênior Front-end na Conta Stone.',
    ...
    en: {
      ...
      description: [
        'Born in Salvador/BA, I grew up in the neighborhood of Mata Escura, currently showing all Bahia dendê oil in São Paulo/SP. I currently work as a senior front-end developer at Stone Banking.',
